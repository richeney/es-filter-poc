archetype_filter = {
  add_policy_assignments = []
  add_policy_definitions = [
    "Contoso-VM-Custom-Logs",
    "Contoso-VM-Extended-Metrics"
  ]
  add_policy_set_definitions = [
    "Contoso-VM-Monitoring"
  ]
  add_role_definitions = []
  ...
  remove_policy_set_definitions = []
  remove_role_definitions       = []
}
